 ...
 */
export function core_md5(x, len)
{
  /* append padding */
  x[len >> 5] |= 0x80 << ((len) % 32);
  x[(((len + 64) >>> 9) << 4) + 14] = len;
 ...
 */
export function core_hmac_md5(key, data)
{
 ...
 */
export function binl2hex(binarray)
{
 ...
 */
export function binl2b64(binarray)
{
